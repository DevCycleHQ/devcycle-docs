...
Organizations are the top level of the Account hierarchy within DevCycle, and are where all Users and Projects are managed. Users within an organization will have the same [permissions](/topics/security-guardrails/permissions) across all projects, and a user may be part of multiple Organizations.
...
[Granular permissions](/topics/security-guardrails/permissions) are only available on business or enterprise plans, if you'd like to turn on permissions message us at support[at]devcycle.com
...
For more information, check out the [Permissions](/topics/security-guardrails/permissions) documentation.
