...
When a user is "Served" a Variation based on the [Targeting Rules](/platform/feature-flags/targeting/targeting-overview), the Variable Values the user receives on their devices or as an API response will be the values for the served Variation.
...
Once this Variation is created, it will become available as an option within the "Serve" dropdown for [Targeting Rules](/platform/feature-flags/targeting/targeting-overview). Users who are served this new Variation will receive the Variable Values associated with this new Variation!
