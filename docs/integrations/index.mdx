...
<CustomDocCardList items={[
  {
    type: 'link',
    href: '/integrations/Github/gh-feature-usage-action',
...
icon:'github'
  ...
  {
    type: 'link',
    href: '/integrations/Github/gh-pr-comment-insights',
  ...
  {
    type: 'link',
    href: '/integrations/Bitbucket/bb-feature-usage-action',
     description: 'Display code snippets for each variable used in a project.',
...
icon:'bitbucket'
    ...
    {
    type: 'link',
    href: '/integrations/Bitbucket/bb-pr-comment-insights',
     description: 'Display code snippets for each variable used in a project.',
