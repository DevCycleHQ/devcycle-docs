...
- DVC supports the following top-level properties on the user object: see [DVC User Object](https://docs.devcycle.com/sdk/client-side-sdks/javascript#dvc-user-object).
