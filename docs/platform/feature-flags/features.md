...
To make the creation and editing of a useful Feature Summary easier, you also have the option to generate a Summary via AI. On next to the edit button there is a "Generate AI Summary" button that adds the details of your Feature to a prompt and uses AI to pull out relevant details.
