...
![Untitled](Realtime%20Updates%20Try%20it%20Yourself%20d3d3c939de254ce2bfba7932275854b4/oct-2022-rtu-demo-1.png)
...
To try it out yourself, we’ve prepared a page that is already hooked up with DevCycle, and it just requires you to make a Feature on the DevCycle website to test it out! No coding required.
...
DevCycle’s feature flags will update in real time on an open website or application utilizing the [subscribe](https://docs.devcycle.com/docs/sdk/client-side-sdks/javascript#subscribing-to-sdk-events) feature within the SDK, allowing your app to update instantaneously for your or your users. This has many use cases, such as:
...
To let you try out DevCycle and realtime updates without needing to actually implement DevCycle, [we’ve prepared a page that has DevCycle variables on it right here](https://devcycle.com/solutions/realtime-update-demo)!

The variables are set up as below, allowing you to modify any of these elements:

![Untitled](Realtime%20Updates%20Try%20it%20Yourself%20d3d3c939de254ce2bfba7932275854b4/oct-2022-rtu-demo-2.png)

Steps:

1. [Sign up for DevCycle](https://devcycle.com/signup) (completely free, no credit card required).
...
![Untitled](Realtime%20Updates%20Try%20it%20Yourself%20d3d3c939de254ce2bfba7932275854b4/oct-2022-rtu-demo-3.png)
...
![Untitled](Realtime%20Updates%20Try%20it%20Yourself%20d3d3c939de254ce2bfba7932275854b4/oct-2022-rtu-demo-4.png)

8. **Save the changes**
9. Now, we can navigate to the website in a different tab
    1. **Add a query param using the SDK Key**

[https://devcycle.com/solutions/realtime-update-demo**?envKey=](https://devcycle.com/solutions/realtime-update-demo?envKey=dvc_client_37a954d5_e21c_4617_be73_63d9682181bd_526e059)YOUR_SDK_KEY_HERE**

![Untitled](Realtime%20Updates%20Try%20it%20Yourself%20d3d3c939de254ce2bfba7932275854b4/oct-2022-rtu-demo-5.png)
