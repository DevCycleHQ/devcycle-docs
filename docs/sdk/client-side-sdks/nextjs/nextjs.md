...
- Minimum Next.js version: 14.0.0
  - Realtime updates functionality is only available in Next.js 14.1 and above due to a bug in Next.js. See [usage](/sdk/client-side-sdks/nextjs/nextjs-usage-app#create-the-devcycle-context-and-export-it) for details
