...
> Projects are nested within [organizations](/essentials/organizations) and contain your [Features](/essentials/overview#features) and [Environments](/essentials/overview#environments) (and through them your [keys](/essentials/keys), [variables](/essentials/variables) and [variations](/essentials/overview#variations)).
