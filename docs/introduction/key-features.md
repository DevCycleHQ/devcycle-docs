...
Here's how:
- Govern who can modify flags in production using [Permissions](/topics/security-guardrails/permissions).
- Allow non-technical users to modify flag values safely, by enforcing [schemas](/topics/security-guardrails/variable-schemas).
- Easily see a [detailed history](/topics/security-guardrails/audit-log) of all changes to flags.
...
- [Override](/topics/development-qa/self-targeting) your own flag values for development or testing in production.
...
- Safely QA your flags in development or right in production with [Self-Targeting](/topics/development-qa/self-targeting).
...
Here's how:
- Store user attributes in a [fast, globally-replicated database](/topics/advanced-targeting/edgedb) and target flags based on those attributes. 
- Easily add a full [feature opt-in](/topics/advanced-targeting/feature-opt-in) experience to your application to allow end users to control their experience.
...
- Notify external systems of changes to your flags using [Outbound Webhooks](/topics/webhooks). 
