...
:::info
Experimentation relies on [Custom Events](/sdk/features#tracking-custom-events). Experimentation is available to all customers on any plan. However, to perform Experiments, events must be sent to DevCycle to calculate Metrics. These events are added to your existing plan. To learn more, read about our [pricing](https://www.devcycle.com/pricing), or contact us.
:::
