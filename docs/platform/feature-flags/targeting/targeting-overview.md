...
User Targeting evaluates rules in a **top-down** order. A User may match the definition of multiple Targeting Rules, however, they will only receieve the first Targeting Rule that they match for the given Environment. 
