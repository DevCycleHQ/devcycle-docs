...
:::info
The Web Debugger is currently in beta. If you have any feedback or suggestions, please let us know by [email](mailto:product@devcycle.com) or on our [Discord](https://discord.gg/pKK4fJgGxG).
:::
...
### Self-Targeting
The Debugger allows you to quickly change your [Self-Targeting Overrides](/topics/development-qa/self-targeting) and see the changes reflected immediately on the current page. If you don't currently have Self-Targeting set up, the Debugger will present an option to quickly set your "DevCycle Identity" to the currently identified user on the page.
