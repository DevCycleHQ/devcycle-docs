...
The Provider implementation is built into the Java SDK. See the [Java Local Server SDK Installation](https://docs.devcycle.com/sdk/server-side-sdks/java/java-local-install) documentation for more information on how to install and the SDK in your project.
