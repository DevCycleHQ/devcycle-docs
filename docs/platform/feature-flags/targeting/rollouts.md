...
For modifications  to or additions of a gradual roll-out, entries in the [Audit Log](/platform/security-and-guardrails/audit-log) will be marked as `Stage 1` and labelled as a `Linear` roll-out. 
