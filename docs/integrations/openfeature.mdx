...
OpenFeature's context model maps directly to DevCycle's [User Properties](/sdk/features#identifying-a-user-or-setting-properties), enabling granular audience segmentation based on user or device-based properties as well as other environmental factors. This ensures your [Targeting Rules](/platform/feature-flags/targeting/targeting-overview) work identically whether you're using DevCycle's native SDKs or the OpenFeature interface.
