...
<DocCardList items={[
  {
    type: 'link',
    href: '/docs/tools-and-integrations/cli',
    label: 'Command Line Interface (CLI)',
  },
  {
    type: 'link',
    href: '/docs/tools-and-integrations/feature-importer',
...
<DocCardList items={[
  {
    type: 'link',
    href: '/docs/tools-and-integrations/Github/gh-feature-usage-action',
    label: 'GitHub Action: Feature Flag Code Usages',
  },
  {
    type: 'link',
    href: '/docs/tools-and-integrations/Github/gh-pr-comment-insights',
    label: 'GitHub Action: Feature Flag Change Insights on Pull Request',
  },
  {
    type: 'link',
    href: '/docs/tools-and-integrations/Bitbucket/bb-feature-usage-action',
    label: 'Bitbucket Pipe: Feature Flag Code Usages',
  },
  {
    type: 'link',
    href: '/docs/tools-and-integrations/Jira/jira-integration',
    label: 'DevCycle Feature Flag Management for Jira',
  },
  {
    type: 'link',
    href: '/docs/tools-and-integrations/terraform',
