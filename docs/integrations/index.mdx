...
<CustomDocCardList
  items={[
    ...
    },
    {
      ...
      description: 'Upload DevCycle configurations to Vercel Edge Config for faster retrieval',
  ...
  items={[
    {
      ...
      label: 'Slack',
      description: 'Connect DevCycle to your Slack workspace to track Feature updates.',
