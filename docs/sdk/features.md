...
For more information on how the default value is used, see [Variable Defaults](/topics/advanced-variables/variable-defaults).
...
about [Custom Property Targeting](/topics/advanced-targeting/custom-properties)
...
For instructions on setting up a custom domain, see [Custom Domains](/topics/custom-domains).
...
Cloud bucketing is required to use specific features such as (EdgeDB)[/topics/advanced-targeting/edgedb] and
(Feature Opt-In)[/topics/advanced-targeting/feature-opt-in]. If you aren't using these features, then Local Bucketing
