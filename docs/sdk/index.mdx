...
<Tabs>
  <TabItem value="client" label="Client-Side SDKs" default>
...
icon:'toggle-on'
  ...
  <TabItem value="server" label="Server-Side SDKs">
...
<Tabs>
 <TabItem value="local" label="Local bucketing SDKs" default>
  ...
  <TabItem value="cloud" label="Cloud bucketing SDKs" >
